...
class CatalogController extends Controller
{
    ...
    private function persistProduct(int $tenantId, Request $request, ?int $productId = null): int
    {
        ...
        $payload = [
            ...
            'min_stock_days' => $request->has('min_stock_days') ? $request->input('min_stock_days') : null,
            'max_stock_days' => $request->has('max_stock_days') ? $request->input('max_stock_days') : null,
